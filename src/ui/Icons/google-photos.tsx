...
const GooglePhotos = ({ width, height, className }: IconProps): ReactElement => (
  <Icon width={width} height={height} className={className} viewBox='135.688 36.52 511.623 510.753'>
    <path
      fill='#DD4B39'
      stroke='#DD4B39'
      strokeWidth='.094'
